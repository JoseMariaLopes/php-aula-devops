...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="#portfolio" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> DEMONSTRAÇÃO</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="#portfolio" class="w3-bar-item w3-button" onclick="toggleFunction()">DEMOSTRAÇÃO</a>
    <a href="#contact" class="w3-bar-item w3-button" onclick="toggleFunction()">CONTATOS</a>
    <a href="#" class="w3-bar-item w3-button">LOCALIZAR</a>
  </div>
</div>
